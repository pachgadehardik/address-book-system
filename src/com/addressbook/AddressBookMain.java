...
public class AddressBookMain {
	...
	static final int SORT_BY_COUNTRY_STATE_ZIP = 10;
...
//				System.out.println();
			...
			case SEARCH_BY_NAME_CITY_STATE: // USECASE 8
				...
				addressBookFunctions.searchContactByName_City_State(personName, city1, state1, addressBook,
						mapAddressNametoBook);
				break;
